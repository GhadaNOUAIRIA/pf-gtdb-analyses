...
accessions <- read_feather("pfitmap.accessions.feather")
# dbsources <- read_feather('pfitmap.dbsources.feather')
domains <- read_feather('pfitmap.domains.feather')
hmm_profiles <- read_feather('pfitmap.hmm_profiles.feather')
proteins <- read_feather('pfitmap.proteins.feather')
sequences <- read_feather('pfitmap.sequences.feather')
taxa <- read_feather('pfitmap.taxa.feather')
# tblout <- read_feather('pfitmap.tblout.feather')
domtblout <- read_feather('pfitmap.domtblout.feather')
```
